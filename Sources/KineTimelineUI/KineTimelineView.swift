...
///   │                          ↑ red playhead                │
///   └───────────────────────────────────────────────────────┘
public final class KineTimelineView: NSView {

    /// Provides live peak level (0...1) for an audio track index.
    /// KineAppUI wires this to TimelineAudioPipeline.peakLevel.
    ...
    /// KineAppUI snapshots these from `WorkspaceModel.previewCache`
    ...
    /// full duration. KineAppUI populates these from
    ...
    /// Mirrors `KineSettings.shared.snappingEnabled`. When false, drag
    ...
    /// thin green bar atop the ruler. Pushed in from KineAppUI each
