// Module umbrella file for KineTimelineUI. The concrete timeline view
// lives in KineTimelineView.swift; placeholders for future tools
...
public struct GapSelection: Equatable, Sendable {
    /// 0 = video, 1 = audio. Matches `KineTimelineView.MoveTargetTrack.kind`.
...
/// Which timeline tool is active. Drives KineTimelineView's mouseDown
