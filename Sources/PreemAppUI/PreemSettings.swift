...
@MainActor
public final class PreemSettings: ObservableObject {
    public static let shared = PreemSettings()

    private let defaults = UserDefaults.standard
    private enum Keys {
        static let defaultTransitionKind = "preem.transition.defaultKind"
        static let defaultTransitionFrames = "preem.transition.defaultFrames"
        static let snappingEnabled = "preem.timeline.snappingEnabled"
    }
...
public struct PreemSettingsView: View {
    @ObservedObject private var settings = PreemSettings.shared
