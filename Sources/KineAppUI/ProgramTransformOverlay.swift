...
private struct TransformHandles: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            // inside this box.
            Rectangle()
                .stroke(KineTheme.accent.opacity(0.85), lineWidth: 1.5)
    ...
    private func edgeHandle(idx: Int, dest: CGRect) -> some View {
        ...
        Rectangle()
            .fill(KineTheme.accent.opacity(0.9))
    ...
    private func rotationGrip(dest: CGRect) -> some View {
        ...
        ZStack {
            ...
            .stroke(KineTheme.accent.opacity(0.7), lineWidth: 1)
