...
/// debug run.
public enum KineDebugLog {
    nonisolated(unsafe) private static let path = "/tmp/kine-debug.log"
    nonisolated(unsafe) private static let queue = DispatchQueue(label: "kine.debug.log")
