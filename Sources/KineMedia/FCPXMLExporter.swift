...
///   * No sequences/timelines (Kine doesn't have them yet in M1)
///
/// When Kine grows a timeline (M2+), this exporter gains a code path
...
public struct FCPXMLExporter: Sendable {
    ...
    private func emitLibrary(project: Project, clips: [ClipSource], formats: [FormatKey: String]) -> String {
        ...
        // One <project>/<sequence>/<spine> per Kine sequence. V1 clips
