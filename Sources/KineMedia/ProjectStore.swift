...
public enum ProjectStore {
    ...
    public enum LoadError: Error, LocalizedError {
        ...
        public var errorDescription: String? {
            ...
            case .decodeFailed(let s): return "Project file is not a valid Kinestasis project: \(s)"
            }
        }
    }
    ...
    public static func autosaveURL(forProjectID id: UUID) -> URL {
        ...
        return dir.appendingPathComponent("\(id.uuidString).kine")
    }
    ...
    /// where the user keeps the `.kine` file.
